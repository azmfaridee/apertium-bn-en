...
/*
    This script is used to generata the data for the meaning table, the data is alreay
    contaied in the dictionay table, you need to populate/update dictionary table before 
    running this script
*/
<?php

    require_once "../config/PersistantConnection.class.php";
    require_once "../verb/Verb.class.php";
